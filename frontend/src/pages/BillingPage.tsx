...
const MODULE_ROWS: ModuleRow[] = [
  ...
  { icon: Calculator,    label: 'Tax Engine',              tip: 'Starter: VAT automation only (set rates, auto-apply at sale). Pro/Business: adds income tax brackets, corporate tax, excise duty, WHT and tax tools', starter: 'VAT only', professional: 'Full', business: 'Full' },
