...
async function exportProductsPDF(products: Product[], org?: Organisation | null) {
  ...
  addDocFooter(doc, { orgName: displayName, docTitle: 'PRODUCT CATALOGUE', docRef: '', BRAND, pdfFont })
...
async function exportHistoryPDF(items: SalesHistoryItem[], product: Product, org?: Organisation | null) {
  ...
  autoTable(doc, {
    ...
    columnStyles: {
      ...
      8: { halign: 'right' as const, fontStyle: 'bold' as const },
    },
  })
  ...
  addDocFooter(doc, { orgName: displayName, docTitle: 'SALES HISTORY', docRef: product.sku, BRAND, pdfFont })
