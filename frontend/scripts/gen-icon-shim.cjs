...
const MAP = {
  ...
  Minus:'Minus', MinusCircle:'MinusCircle', Moon:'Moon', Package:'Package', Pencil:'PencilSimple', Phone:'Phone',
  PieChart:'ChartPie', Play:'Play', Plus:'Plus', Receipt:'Receipt', RefreshCw:'ArrowsClockwise',
...
for (const lucide of names){
  ...
  used.add(resolved)
  lines.push(`export const ${lucide} = mk('${resolved}')`)
}
